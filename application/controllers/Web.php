			...
			if ($_POST['thn_lahir'] > 2016 ) {
				$this->session->set_flashdata('msg',
					...
					<div class="alert alert-warning alert-dismissible" role="alert">
						 ...
						 <strong>Gagal Mendaftar PPDB Online!</strong> Maaf <b>'.$nama_lengkap.'</b> tidak bisa mendaftar PPDB dikarenakan usia anda kurang dari 7 Tahun. Terimakasih.
					</div>'
				);
