  ...
  <div class="panel-body">
    ...
    <!-- <div class="form-group" style="padding-bottom:30px;">
        ...
        <div class="col-sm-9 prepend-icon" style="margin-top:1px;">
          ...
          <div id="pesan_komentar">*Sesuai dengan data dari Akta Kelahiran</div>
        </div>
    </div>
 -->
  <div class="form-group" style="padding-bottom:30px;">
      <label class="col-sm-3 control-label"style="text-align:right; margin-top:6px">No Induk Kependudukan<span class="text-danger">*</span></label>
      <div class="col-sm-9 prepend-icon" style="margin-top:1px;">
        ...
        <div id="pesan_komentar">*Sesuai dengan data dari Discapil</div>
      </div>
  </div>
  ...
  <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon">
        ...
        <div id="pesan_komentar">*Sesuai dengan Akta/KK</div>
      </div>
  </div>
...
<div class="form-group">
    ...
    <div class="col-sm-9" style="margin-top:3px;">
      ...
      <div id="error-status_keluarga" style=" background:#FFBABA;color: #D8000C; width:auto;border-radius:5px;padding-left:10px;"></div>
        ...
        <div class="form-group" style="padding-bottom:30px;">
      <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Asal TK/PAUD  <span class="text-danger">*</span></label>
      <div class="col-sm-9 prepend-icon">
