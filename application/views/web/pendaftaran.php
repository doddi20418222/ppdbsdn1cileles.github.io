...
<head>
    ...
    <title>PPDB SD NEGERI 1 CILELES</title>
  ...
  <body class="fixed-topbar theme-sdtl color-green  sidebar-hover">
    ...
    <section>
      ...
      <div class="main-content">
        <!-- BEGIN TOPBAR -->
        <div class="topbar" style="background-color:#2874A6;color:#fff;">
          <div class="header-left">
            <div class="col-sm-12">
              <div style="margin-top:-8px;">
              <h2>
								<strong class="text-primary">
									<a href=""><img src="img/1.png" alt="Logo" width="30" style="position:absolute;margin-top:-8px;"> <span style="margin-left:35px;color:#fff;">PPDB Online</span></a>
								</strong>
							</h>
              </div>
            </div>
      ...
      <div>
        ...
        <div class="page-content page-wizard">
          ...
          <div class="header" style="margin-top:-20px;">
            <h2>Form Pendaftaran PPDB Online <strong>SD NEGERI 1 CILELES</strong></h2>
                        ...
                        <fieldset>
                           ...
                           <div class="form-group" >
                              ...
                              <span style="font-size:15px">
                                 Proses PPDB Online SD NEGERI 1 CILELES hampir selesai. Silakan periksa kembali data-data calon siswa yang sudah anda masukkan.
                                 <br><br>
                                 <div class="col-md-12" >
          ...
          <div class="footer">
            <div class="copyright">
              <p class="pull-left sm-pull-reset">
                <span>Copyright &copy; <a href="http://www.123.sch.id" target="_blank">SD NEGERI 1 CILELES</a> <?php echo date('Y'); ?> | SUBU</span>
              </p>
